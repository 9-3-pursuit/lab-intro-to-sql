...
-- 
\echo 'Query for all columns in the gifts table:'
SELECT column_name
...
-- 
\echo Insert  more gifts of your own choosing,  include 1 more candle
--
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('dress', 'neighbor', '1000', false),
('fruits', 'mom', '50', false),
('knives', 'friend', '200', true),
('gift card', 'cousin', '300', true),
('shorts', 'sister', '1000', false);

--
\echo Query for gifts with a price greater than or equal to 20
--

SELECT gifts FROM gifts WHERE price>=20;
