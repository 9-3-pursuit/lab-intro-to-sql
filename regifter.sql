...
INSERT INTO gifts (gift, giver, price, previously_regifted) VALUES ('peachcandle', 'Santa', 9, true);
-- 
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('cherry candle', 'Santa', '9', TRUE),
('pants', 'Nick', '75', FALSE),
('shower gel', 'Rudolf', '30', FALSE),
('phone', 'Elf on the Shelf', '200', FALSE),
('laptop', 'The Boss', '1000', FALSE)
;
--
...
then SELECT * FROM gifts to query for the updated whole list 
-- 
