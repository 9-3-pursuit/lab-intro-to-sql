...
--
    ...
    INSERT INTO gifts (gift, giver, value, previously_regifted)
    VALUES
    ('lavender candle', 'Frosty', '11', FALSE),
    ('Ear Buds', 'Mrs. Claus', '50', FALSE),
    ('Massage Gun', 'Jack Frost', '30', TRUE),
    ('Headphones', 'Scrooge', '39', TRUE),
    ('gift card', 'Burgermeister Meisterburger', '5', TRUE)
    ;
