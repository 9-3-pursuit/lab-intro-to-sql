...
CREATE TABLE gifts (id SERIAL PRIMARY KEY, gift VARCHAR, giver VARCHAR, 
value INTEGER, previously_regifted BOOLEAN);
...
VALUES ('peach candles', 'Santa', 9, true);
...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES 
  ('chocolate', 'John', 15, false),
  ('book', 'Alice', 20, true),
  ('perfume', 'Kate', 50, false),
  ('candle', 'Tom', 10, true),
  ('watch', 'Peter', 100, false);
