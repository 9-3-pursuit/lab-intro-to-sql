...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('vanilla-spice candle', 'Junior', '35', FALSE),
('headphones', 'Mike', '50', TRUE),
('shampoo', 'Shy', '28', FALSE),
('giftcard', 'Eb', '30', TRUE),
('chocolate', 'Mum', '52', TRUE);
...
--
SELECT * FROM gifts WHERE giver = 'Santa' OR vale > 30;
...
--
SELECT * FROM gifts ORDER BY price DESC;
--
-- finish
--
