...
VALUES 
('vanilla candle', 'Comet', 10, FALSE),
('apple pie', 'Mrs. Claus', 2, TRUE),
('candy cane', 'Gnome', 30, FALSE),
('sleigh', 'Dasher', 1, TRUE),
('snow', 'Mother Earth', 100, TRUE)
;
...
--
SELECT * FROM gifts WHERE gift LIKE '%in%';
