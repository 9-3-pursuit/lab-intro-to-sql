...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('lemon candle', 'Superman', '18', TRUE),
('freedom', 'Trump', '0', TRUE),
('cheese', 'Cow', '50', FALSE),
('ice cream', 'Joe Biden', '5', TRUE),
('alligator shoes', 'Boss', '400', FALSE)
;
...
-- 
SELECT COUNT(*) as candle_gifts_count FROM gifts
WHERE gift LIKE '%candle%';
