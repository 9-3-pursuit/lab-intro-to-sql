...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('caramel candle', 'Santa', '9', TRUE),
('football', 'Ninja', '19', TRUE),
('Headphones', 'Austin', '29', FALSE),
('pumpkin candle', 'Elf on the Shelf', '13', TRUE),
('Beats', 'Marangely', '150', FALSE)
; 
SELECT * FROM gifts;
...
SELECT COUNT(*) AS "Number of Gifts" FROM gifts WHERE gift LIKE '%candle%';
